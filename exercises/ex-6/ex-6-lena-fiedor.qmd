...
First, we have to extract the samples of virginica and versicolor species. Then we group the table by these species and add four columns containg maximum values calculated for each trait.
